...
const Feature = () => {
  ...
  return (
    <section className="bg-white rounded-t-2xl dark:bg-gray-900 h-screen">
      <div className="relative flex items-center justify-center h-full ml-12 mr-12 gap-6 overflow-hidden">
